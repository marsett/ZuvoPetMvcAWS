...
{
    [AuthorizeZuvoPetMvcAWS("Refugio")]
    public class RefugioController : Controller
    {
        ...
        public RefugioController(/*ZuvoPetMvcAWSContext context,*/ ServiceZuvoPet service, /*HelperPathProvider helperPath,*/ IHubContext<ChatHub> hubContext)
        {
