...
namespace ZuvoPetMvcAWS.Filters
{
    public class AuthorizeZuvoPetMvcAWSAttribute : AuthorizeAttribute, IAuthorizationFilter
    {
        private readonly string[] _tiposUsuario;

        public AuthorizeZuvoPetMvcAWSAttribute(params string[] tiposUsuario)
        {
